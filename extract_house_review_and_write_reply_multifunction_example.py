...
def load_json_file(file_path: Union[str, Path]) -> Dict[str, Any]:
    """
    Load and parse a JSON file with improved error handling.
    ...
    try:
        ...
        logger.error(f"JSON decoding failed in {file_path} at line {e.lineno}, column {e.colno}: {e.msg}")
        raise
...
if __name__ == "__main__":
    try:
        ...
        function_def = load_function_definition('./resources/two_functions_extraction_and_review_reply.json')
